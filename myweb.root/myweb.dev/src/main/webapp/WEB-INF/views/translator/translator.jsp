    ...
    <div class="left">
        <span style="float:right">
            <label style="margin-right: 10px;">
                <input type="checkbox" id="autoLan" value="autoLan" style="vertical-align: middle;">
                자동 언어 감지
            </label>
            <label for="kind" class="label-inline">출발언어
            <select id="kind" class="select-inline">
                <option value="JPP">한국어</option>
                <option value="JL">영어</option>
                <option value="XPP">중국어(간체)</option>
                <option value="XL">중국어(번체)</option>
                <option value="XaL">일본어</option>
            </select>
            </label>
